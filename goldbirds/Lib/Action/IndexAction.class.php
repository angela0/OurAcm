...
class IndexAction extends BaseAction {
    ...
    public function index() {
        ...
        $data['province'][0] = $contestDB -> where('type = 2 AND medal = 0') -> getField('COUNT(*) AS c');
        $data['province'][1] = $contestDB -> where('type = 2 AND medal = 1') -> getField('COUNT(*) AS c');
        $data['province'][2] = $contestDB -> where('type = 2 AND medal = 2') -> getField('COUNT(*) AS c');
