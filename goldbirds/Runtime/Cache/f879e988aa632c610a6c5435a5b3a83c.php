...
<html>
  <head>
	...
	$(function(){
		$(function(){ $("#navbar li:nth-child(4)").addClass("active"); });  //如果需要调整navbar上便选项的顺序，调整后需要更改这里的 li:nth-child() 里买你的值,包括cool.html, data.html, nodata.html
    ...
    <div class="row">
      <div class="span3 bs-docs-sidebar">
        <ul class="nav nav-list bs-docs-sidenav">
       	  <li class="selected"><a href="?z=regional-cool"><i class="icon-chevron-right"></i> 酷炫版</a></li>
          <?php foreach($y as $vo) { if($vo['y'] == $year) echo '<li class="active"><a><i class="icon-chevron-right"></i> -- '.$vo['y'].'年</a></li>'; else echo '<li><a href="?z=regional-cool-y-'.$vo['y'].'#top"><i class="icon-chevron-right"></i> -- '.$vo['y'].'年</a></li>'; } ?>
          <li><a href="?z=regional-data"><i class="icon-chevron-right"></i> 表单版</a></li>
        </ul>
      </div>
      <div class="span9">
      	<section id="top">
